    ...
    <div className="sweet-pro-container">
      ...
      <section className="sweet-pro-hero">
        ...
        >
          ...
          >
            Create, deploy, and manage enterprise AI voice agents that automate customer interactions, execute business workflows, and deliver natural conversations—all from a single platform.
          </motion.p>
          ...
          >
            <Link to="/contact" className="btn-pro-solid">Schedule a Demo</Link>
            <a href="#capabilities" className="btn-pro-outline">Explore Platform ↓</a>
          </motion.div>
          ...
          >
            ...
            <div className="marquee-track">
              {["Twilio Telephony", "Salesforce CRM", "HubSpot CRM", "WhatsApp Business", "Genesys Cloud", "Slack Integration", "Google Calendar", "SAP ERP", "Okta Identity"].map((item, idx) => (
                <span key={idx}>{item}</span>
              ))}
              {["Twilio Telephony", "Salesforce CRM", "HubSpot CRM", "WhatsApp Business", "Genesys Cloud", "Slack Integration", "Google Calendar", "SAP ERP", "Okta Identity"].map((item, idx) => (
                <span key={`dup-${idx}`}>{item}</span>
      ...
      <section className="sweet-pro-section sweet-pro-showcase-section">
        <motion.div className="container" {...sectionAnimation}>
          <div className="sweet-pro-showcase-header">
            ...
            <p className="sweet-pro-section-desc">
              From healthcare claims to agricultural advising, SweetHello powers robust, domain-specific voice assistants that run on secure, scalable cloud architectures.
            </p>
          </div>
        </motion.div>
        ...
        <div className="sweet-pro-showcase-track">
          <div className="sweet-pro-showcase-list" ref={showcaseScrollRef}>
            {[
              { title: "Cadence", industry: "Healthcare Claims Automation", desc: "Instantly verify insurance coverage, process medical claims, and resolve policy inquiries with zero wait times.", icon: <ShieldCheck size={28} strokeWidth={1.5} /> },
              { title: "Adama Krishi Mitra", industry: "Agriculture Advisory", desc: "Deliver real-time farming advisory, soil health data, and local crop pricing in native regional languages.", icon: <Globe size={28} strokeWidth={1.5} /> },
              { title: "Travel Assistant", industry: "Booking & Customer Support", desc: "Automate flight adjustments, hotel bookings, and complex itinerary questions around the clock.", icon: <Compass size={28} strokeWidth={1.5} /> },
              { title: "Retail Assistant", industry: "Order Tracking & Customer Service", desc: "Manage order tracking, process refunds, and answer shipping status queries instantly.", icon: <Layers size={28} strokeWidth={1.5} /> },
              { title: "Custom Enterprise Agents", industry: "Built for your business", desc: "Tailored to your specific enterprise architecture, APIs, workflows, and database layers.", icon: <Cpu size={28} strokeWidth={1.5} /> }
            ].map((agent, idx) => (
        ...
        <motion.div className="container" {...sectionAnimation}>
          <div className="sweet-pro-quote">
            ...
            <h2>SweetHello is an enterprise AI Voice Agent Platform that enables organizations to build, deploy, and manage intelligent voice agents for customer engagement and business operations.</h2>
          </div>
        </motion.div>
      </section>
        ...
        <motion.div className="container" {...sectionAnimation}>
          <div className="text-center" style={{ marginBottom: "64px" }}>
            ...
            <p className="sweet-pro-section-desc centered">
              Equip your organization with a single comprehensive stack to create, orchestrate, and optimize conversational voice streams.
            </p>
          </div>

          <div className="capabilities-grid">
            {[
              { title: "AI Agent Builder", desc: "Create AI voice agents for any business use case.", icon: <Cpu size={28} strokeWidth={1.5} /> },
              { title: "Voice Studio", desc: "Customize voice, language, and conversation style.", icon: <Headphones size={28} strokeWidth={1.5} /> },
              { title: "Knowledge Hub", desc: "Equip agents with business knowledge and documents.", icon: <Lightbulb size={28} strokeWidth={1.5} /> },
              { title: "Conversations", desc: "Manage calls, transcripts, and interaction history.", icon: <Phone size={28} strokeWidth={1.5} /> },
              { title: "Analytics", desc: "Monitor performance through real-time dashboards.", icon: <BarChart3 size={28} strokeWidth={1.5} /> },
              { title: "Integrations", desc: "Connect with CRM, ERP, telephony, and enterprise systems.", icon: <Workflow size={28} strokeWidth={1.5} /> }
            ].map((cap, idx) => (
      ...
      <section className="sweet-pro-section sweet-pro-works-section">
        <motion.div className="container" {...sectionAnimation}>
          <div style={{ marginBottom: "64px", textAlign: "left" }}>
            ...
            <p className="sweet-pro-section-desc">
              Create an AI voice agent, customize its behavior, deploy it instantly, and monitor every conversation from a unified dashboard.
            </p>
          </div>

          <div className="sweet-pro-works-flow">
            {[
              { step: "01", title: "Create", desc: "Describe your agent's objective and outline core conversational goals in natural language." },
              { step: "02", title: "Configure", desc: "Build behavior, select accents and languages, and link databases or documents in the Knowledge Hub." },
              { step: "03", title: "Deploy", desc: "Launch instantly onto telephony networks (SIP/PSTN), web portals, messaging systems, or native apps." },
              { step: "04", title: "Monitor", desc: "Analyze live transcripts, track interaction history, evaluate sentiment, and continuously improve models." }
            ].map((item, idx) => (
              <div key={idx} className="sweet-pro-works-card">
                <div className="works-step-num">{item.step} • {item.title}</div>
                <h3>{item.title}</h3>
                <p>{item.desc}</p>
              </div>
            ))}
          ...
          <div className="sweet-pro-bento-grid">
            ...
            <div className="sweet-bento-card bento-wide">
              ...
              <div className="sweet-bento-content">
                <span className="sweet-bento-icon"><Headphones size={20} /></span>
                <h3>Human-like Conversations</h3>
                <p>Natural speech patterns, dynamic interruption handling, and ultra-low latency text-to-speech for seamless conversations.</p>
            ...
            <div className="sweet-bento-card">
              <div className="sweet-bento-glow-spot" />
              <div className="sweet-bento-content">
                <span className="sweet-bento-icon"><Globe size={20} /></span>
                <h3>Multi-language Support</h3>
                <p>Equipped to speak and understand 50+ languages and accents globally, ensuring localized customer engagement.</p>
              </div>
            </div>
            ...
            <div className="sweet-bento-card">
              <div className="sweet-bento-glow-spot" />
              <div className="sweet-bento-content">
                <span className="sweet-bento-icon"><Phone size={20} /></span>
                <h3>Intelligent Call Routing</h3>
                <p>Determine intent instantly and execute warm call transfers to appropriate departments or live agents.</p>
              </div>
            </div>
            ...
            <div className="sweet-bento-card bento-wide">
              <div className="sweet-bento-glow-spot" />
              <div className="sweet-bento-content">
                <span className="sweet-bento-icon"><Lightbulb size={20} /></span>
                <h3>Knowledge-driven Responses</h3>
                <p>RAG architecture feeds agents with up-to-date business wikis, PDFs, FAQs, and product sheets for accurate answers.</p>
            ...
            <div className="sweet-bento-card">
              <div className="sweet-bento-glow-spot" />
              <div className="sweet-bento-content">
                <span className="sweet-bento-icon"><BarChart3 size={20} /></span>
                <h3>Conversation Analytics</h3>
                <p>Complete transcript indexing, automated sentiment analysis, and operational performance dashboards.</p>
              </div>
            </div>
            ...
            <div className="sweet-bento-card">
              <div className="sweet-bento-glow-spot" />
              <div className="sweet-bento-content">
                <span className="sweet-bento-icon"><Workflow size={20} /></span>
            ...
            <div className="sweet-bento-card">
              <div className="sweet-bento-glow-spot" />
              <div className="sweet-bento-content">
                <span className="sweet-bento-icon"><ShieldCheck size={20} /></span>
                <h3>Secure Operations</h3>
                <p>Enterprise compliance including HIPAA guidelines, SOC2 framework standards, and encrypted communications.</p>
              </div>
            </div>
            ...
            <div className="sweet-bento-card">
              <div className="sweet-bento-glow-spot" />
              <div className="sweet-bento-content">
                <span className="sweet-bento-icon"><Clock size={20} /></span>
          ...
          <div className="industries-grid" style={{ gridTemplateColumns: "repeat(5, 1fr)" }}>
            {[
              ...
              <div key={idx} className="industry-card" style={{ padding: "24px 16px", minHeight: "140px" }}>
                <div className="showcase-icon-box" style={{ marginBottom: "12px" }}>{useCase.icon}</div>
      ...
      <section className="sweet-pro-section sweet-pro-works-section">
        <motion.div className="container" {...sectionAnimation}>
          ...
          <div className="why-grid">
            {[
              { title: "Faster Customer Response", desc: "Reduce wait times to zero. Greet every customer instantly with automated response streams.", icon: "⚡" },
              { title: "Intelligent Automation", desc: "Trigger multi-system workflows, update databases, and complete bookings directly from speech.", icon: "🤖" },
              { title: "Operational Efficiency", desc: "Drive cost reductions up to 80% per customer contact while maintaining QA scores.", icon: "📈" },
              { title: "Enterprise Scale", desc: "Deploy highly available global systems backed by robust SLA metrics and SOC2 security frameworks.", icon: "🌍" }
            ].map((why, idx) => (
